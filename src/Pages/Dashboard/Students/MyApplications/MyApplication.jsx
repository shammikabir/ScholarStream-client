          ...
          <tbody className="text-[17px] divide-y divide-gray-200">
            {applications.map((app, index) => (
              <tr key={app._id} className="hover:bg-gray-50 transition">
                ...
                <td className="p-3 font-semibold">{app.universityName}</td>
                ...
                <td className="p-3">${app.fees}</td>
                <td className="p-3">{app.applicationStatus}</td>
                <td className="p-3">{app.paymentStatus}</td>
                <td className="p-3 flex flex-wrap gap-2">
                  {/* Details */}
                  <button
                    className="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-700 hover:text-white transition"
                  ...
                  {app.applicationStatus === "pending" && (
                    <button
                      className="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-600 hover:text-white transition"
                  ...
                  {app.applicationStatus === "pending" && (
                    <button
                      className="px-3 py-1 bg-red-100 text-red-700 rounded-lg hover:bg-red-600 hover:text-white transition"
                  ...
                  {app.applicationStatus === "pending" &&
                    app.paymentStatus === "unpaid" && (
                      <button
                        className="px-3 py-1 bg-green-100 text-green-700 rounded-lg hover:bg-green-700 hover:text-white transition"
                        onClick={() =>
